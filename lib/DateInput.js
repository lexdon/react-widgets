...
module.exports = React.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    this._setState(nextProps, function (text) {
      _this.setState({
        textValue: text
      });
    });
  ...
  getInitialState: function getInitialState() {
    return this._setState(this.props, function (text) {
      return {
        textValue: text
      };
    });
  ...
  _setState: function _setState(props, cb) {
    if (props.value instanceof Date) {
      var text = formatDate(props.value, props.editing && props.editFormat ? props.editFormat : props.format, props.culture, this.props.presenter);
  ...
  _blur: function _blur(e) {
    ...
    if (this._needsFlush) {
      ...
      this.props.onChange(localizers.date.parse(val, this.props.format, this.props.culture, this.props.dateValidator, input), val);
    }
  },
...
function formatDate(date, format, culture, props) {
  ...
  if (date instanceof Date && isValid(date)) val = localizers.date.format(date, format, culture, props ? props.presenter : undefined);
