    ...
    return (
      <div style={{ fontSize: 14 }}>
        <div style={{ maxWidth: 600, height: 1500 }}>
          ...
          <DatePicker focusedClass="hocus-pocus" errorClass="error" displayError={false} id="test" culture='nb' time={false} max={new Date()} min={moment().subtract(3, 'years').toDate()} defaultValue={new Date()} onChange={this.onChange} />
          {/*<NumberPicker />*/}
