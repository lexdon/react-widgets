...
var DatePicker = React.createClass({
  ...
  hintText: function hintText() {
    var format = '';
    if (this.props.culture === 'en') format = 'MM/DD/YY';else format = 'DD.MM.YY';
    return format;
  },

  setHintText: function setHintText() {
    this.state.inputValueStore.value = this.hintText();
    this.setState({ culture: this.state.culture });
  },

  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    if (nextProps.empty) this.setHintText();
  },

  componentDidMount: function componentDidMount() {
    yearBreakpoint = this.props.twoDigitYearBreakpoint;
    if (this.props.empty) this.setHintText();else this.presenter(this.props.defaultValue);
  },
  ...
  render: function render() {
    ...
    return React.createElement(
      'div',
      null,
      this.props.native ? React.createElement('input', { type: 'date', defaultValue: moment().format('YYYY-MM-DD') }) : React.createElement(DateTimePicker, {
